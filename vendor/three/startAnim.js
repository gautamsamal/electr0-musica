...
function init() {
	...
	new THREE.FontLoader().load('vendor/three/fonts.js', function (font) {
...
function createTweenScrubber(tween, seekSpeed) {
	...
	function stop() {
		...
		setTimeout(function () {
			...
			music.play();
			setTimeout(function () {
				responsiveVoice.speak("Project JARRE Presents", "UK English Male", {pitch:1, onend: function(){
				}});
			},3000);
		}, 100);
	}
